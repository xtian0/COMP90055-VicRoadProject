...
import argparse
import os
from yolo_count import YOLO, detect_video
...
def detect_img(yolo):
    while True:
        ...
        try:
            ...
            r_image = yolo.detect_image(image, single_image=True)
            r_image.show()
    yolo.close_session()
...
def detect_imgdir(yolo, dir, output_txt=False):
    ...
    for img in img_files:
        try:
            ...
            r_image = yolo.detect_image(image, single_image=True, output=detections)
