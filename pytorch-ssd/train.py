...
parser.add_argument('--dataset', default='VICROADS', choices=['VICROADS','VOC', 'COCO'],
                    type=str, help='VOC or COCO')
parser.add_argument('--dataset_root', default=VICROADS_ROOT,
...
def train():
    if args.dataset == 'VICROADS':
        if args.dataset_root != VICROADS_ROOT:
            if not os.path.exists(VICROADS_ROOT):
                parser.error('Must specify dataset_root if specifying dataset')
            print("WARNING: Using default VICROADS dataset_root because " +
                  "--dataset_root was not specified.")
            args.dataset_root = VICROADS_ROOT
        cfg = vicroads
        dataset = VICROADSDetection(root=args.dataset_root,
    ...
    torch.save(ssd_net.state_dict(),
               args.save_folder + '' + args.dataset + '_final.pth')
